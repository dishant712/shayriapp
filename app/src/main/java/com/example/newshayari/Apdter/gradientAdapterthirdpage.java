...
public class gradientAdapterthirdpage extends BaseAdapter {

    Shayari shayari;
    public gradientAdapterthirdpage(Shayari shayari) {
    this.shayari=shayari;
    }

    public gradientAdapterthirdpage(pencill pencill) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(shayari).inflate(R.layout.extra_gradient_item,parent,false);
